...
#
    ...
    0xb027 => { #2
        ...
        Writable => 'int32u',
        SeparateTable => 1,
        # set to 65535 for E-Mount lenses (values 1000-1255)
        ValueConvInv => '($val < 1000 or $val > 1255) ? int($val) : 65535',
...
#           difference between 0x0002 and 0x0004 mostly 0.0, 0.1 or 0.2 stops.
    ...
    0x0107 => {
        ...
        Condition => '$$self{Model} =~ /^NEX-/',
        Notes => q{
            NEX models only.  Numerical values have 1000 added to avoid confusion with
            the values of other Sony LensType tags
        },
        RawConv => '$priority = 0 unless $val; $val', # lower priority if value is 0
        ValueConv => '$val + 1000',
        ValueConvInv => '($val < 1000 or $val > 1255) ? 0 : $val - 1000',
        PrintConv => {
            1000 => 'Unknown E-Mount or A-Mount Lens',
            # 1001 - seen this for the E 50mm F1.8 OSS (bad sample?) - PH
            1016 => 'Sony E 16mm F2.8', #PH
            1017 => 'Sony E 18-55mm F3.5-5.6 OSS',
            1019 => 'Sony E 18-200mm F3.5-6.3 OSS',
            1020 => 'Sony E 30mm F3.5 Macro',
            1021 => 'Sony E 24mm F1.8 ZA',
            1022 => 'Sony E 50mm F1.8 OSS',
            1024 => 'Sony E 10-18mm F4 OSS',
            1025 => 'Sony E PZ 16-50mm F3.5-5.6 OSS',
            1031 => 'Sony E 35mm F1.8 OSS',
            # ? => 'Sony E 20mm F2.8',
