...
MetadataElement::MetadataElement(const MetadataElement &value) {
    string = value.string;
    date   = value.date;
    type   = value.type;
}
MetadataElement& MetadataElement::operator= (const MetadataElement &value) {
    string = value.string;
    date   = value.date;
    type   = value.type;
    return *this;
...
MetadataElement::MetadataElement(const QString &value) {
    setString(value);
}
MetadataElement& MetadataElement::operator= (const QString &value) {
    setString(value);
    return *this;
}

MetadataElement::MetadataElement(const QDateTime &value) {
    setDateTime(value);
}
MetadataElement& MetadataElement::operator= (const QDateTime &value) {
    setDateTime(value);
    return *this;
}

void MetadataElement::setString(const QString &value) {
    string = value;
    type   = MetadataElementTypeString;
}
void MetadataElement::setDateTime(const QDateTime &value) {
    date   = value;
    string = date.toString("yyyy:MM:dd hh:mm:ss");
    type   = MetadataElementTypeDate;
}
